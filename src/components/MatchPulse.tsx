  ...
  <section className="container py-10">
    <div className="mb-5 flex items-end justify-between">
      <div>
        ...
        <h2 className="font-display mt-2 text-4xl uppercase tracking-wide md:text-6xl">Match pulse.</h2>
        <p className="mt-2 text-sm text-muted-foreground">Where 200K traders place real money conviction — refreshed every over alongside the order book.</p>
      </div>
    </div>
